...
// Use the HTTPHeaderTokenStrategy within Passport.
...
//   credentials (in this case, a token), and invoke a callback with a user
//   object.
passport.use(new HTTPHeaderTokenStrategy({ "passReqToCallback": true },
...
// curl -v http://127.0.0.1:3000/ -H "Authorization: Token 123456789"
app.get('/',
  // Authenticate using HTTP header token credentials, with session support disabled.
